...
var app = (function (Keyboard) {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$9, 206, 4, 5285);
    			...
    			add_location(article, file$9, 193, 2, 4963);
    		},
    		m: function mount(target, anchor) {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h3, file$9, 236, 10, 6261);
    		},
    		m: function mount(target, anchor) {
    ...
    // (235:6) <CompletedMessage showConfetti="{showConfetti}">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(235:6) <CompletedMessage showConfetti=\\\"{showConfetti}\\\">",
    		ctx
    	});
