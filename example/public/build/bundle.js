...
var app = (function (Keyboard) {
    ...
    const file = "Users/graeme.hoffman/Documents/WORK/crossword/src/Toolbar.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*action*/ ctx[6] === "clear") return create_if_block;
    		if (/*action*/ ctx[6] === "reveal") return create_if_block_1;
    ...
    const file$1 = "Users/graeme.hoffman/Documents/WORK/crossword/src/Cell.svelte";
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(line, file$1, 108, 4, 2459);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(text_1, file$1, 112, 4, 2528);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(g, file$1, 94, 0, 2037);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$2 = "Users/graeme.hoffman/Documents/WORK/crossword/src/Puzzle.svelte";
    ...
    const file$3 = "Users/graeme.hoffman/Documents/WORK/crossword/src/Clue.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(strong, file$3, 25, 4, 666);
    			...
    			add_location(button, file$3, 18, 2, 413);
    			add_location(li, file$3, 17, 0, 357);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$4 = "Users/graeme.hoffman/Documents/WORK/crossword/src/ClueList.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(p, file$4, 11, 0, 226);
    			attr_dev(ul, "class", "svelte-16s2wyn");
    			add_location(ul, file$4, 13, 2, 266);
    ...
    const file$6 = "Users/graeme.hoffman/Documents/WORK/crossword/src/Clues.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$6, 36, 2, 971);
    			attr_dev(div1, "class", "clues--list svelte-fisq29");
    			add_location(div1, file$6, 40, 2, 1069);
    			...
    			add_location(section, file$6, 35, 0, 902);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    ...
    const file$7 = "Users/graeme.hoffman/Documents/WORK/crossword/src/Confetti.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(svg, file$7, 43, 0, 2378);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$8 = "Users/graeme.hoffman/Documents/WORK/crossword/src/CompletedMessage.svelte";
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div0, file$8, 12, 6, 266);
    			attr_dev(button, "class", "svelte-hm3hg2");
    			add_location(button, file$8, 16, 6, 325);
    			attr_dev(div1, "class", "content svelte-hm3hg2");
    			add_location(div1, file$8, 11, 4, 238);
    			attr_dev(div2, "class", "completed svelte-hm3hg2");
    			add_location(div2, file$8, 10, 2, 180);
    			attr_dev(div3, "class", "curtain svelte-hm3hg2");
    			add_location(div3, file$8, 25, 2, 509);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$8, 20, 6, 431);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    class CompletedMessage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { showConfetti: 0 });
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$9, 203, 4, 5152);
    			...
    			add_location(article, file$9, 190, 2, 4830);
    		},
    		m: function mount(target, anchor) {
    ...
    // (231:4) {#if isComplete && !isRevealing && showCompleteMessage}
    function create_if_block_1$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(231:4) {#if isComplete && !isRevealing && showCompleteMessage}",
    		ctx
    	});
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h3, file$9, 233, 10, 6128);
    		},
    		m: function mount(target, anchor) {
    ...
    // (232:6) <CompletedMessage showConfetti="{showConfetti}">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(232:6) <CompletedMessage showConfetti=\\\"{showConfetti}\\\">",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*validated*/ ctx[12] && create_if_block$4(ctx);
    ...
    // (52:6) <div         class="toolbar"         slot="toolbar"         let:onClear         let:onReveal         style="background: #333; padding: 1em; margin: 1em 0;"       >
    function create_toolbar_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$a, 51, 6, 1327);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button0);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*onClear*/ ctx[0])) /*onClear*/ ctx[0].apply(this, arguments);
    						},
    						false,
    						false,
    						false
    					...
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*onReveal*/ ctx[1])) /*onReveal*/ ctx[1].apply(this, arguments);
    						},
    						false,
    						false,
    						false
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(52:6) <div         class=\\\"toolbar\\\"         slot=\\\"toolbar\\\"         let:onClear         let:onReveal         style=\\\"background: #333; padding: 1em; margin: 1em 0;\\\"       >",
    		ctx
    	});
    ...
    function create_message_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h3, file$a, 68, 8, 1816);
    			...
    			add_location(img, file$a, 69, 8, 1848);
    			attr_dev(div, "slot", "message");
    			add_location(div, file$a, 67, 6, 1787);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    // (51:4) <Crossword data="{dataNYTDaily}">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(51:4) <Crossword data=\\\"{dataNYTDaily}\\\">",
    		ctx
    	});
    	...
    	crossword2 = new Crossword({
    			props: {
    				...
    				$$slots: {
    					...
    					toolbar: [
    						create_toolbar_slot,
    						({ onClear, onReveal }) => ({ 0: onClear, 1: onReveal }),
    						({ onClear, onReveal }) => (onClear ? 1 : 0) | (onReveal ? 2 : 0)
    					]
    				},
    				$$scope: { ctx }
    			},
